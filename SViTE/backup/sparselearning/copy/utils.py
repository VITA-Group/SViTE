...
def get_cifar10_dataloaders(args, validation_split=0.0, max_threads=10):
    ...
    train_loader_jac = torch.utils.data.DataLoader(
        full_dataset,
        batch_size=args.batch_size_jac, shuffle=False, num_workers=1,
        pin_memory=True)

    return train_loader, valid_loader, test_loader, train_loader_jac
